...
- **Before sending any install steps**, run the Install-Step Gate in `01_CODE_GOVERNANCE_UPDATED.md`. For a customer, a step that needs a new snippet becomes "contact Pixfizz support".
